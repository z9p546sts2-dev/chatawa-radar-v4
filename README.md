...
## Status: PHASE 5 AUTHORIZED — UNITS 7–1400 COMPLETE WITHIN LOCAL-SOFTWARE SCOPE
...
PHASE 5 — AUTHORIZED-TC / UNITS 7–1400 COMPLETE WITHIN LOCAL-SOFTWARE SCOPE
...
The full unit ledger is `docs/UNITS.md`. Completing units 7–1400 is inspectability, not a research result.
...
- `docs/legacy/RADAR_V4_REACTIVATION_REVIEW_TC.md` — pre-Build-Unit-1 check. Later superseded as current status by completed Units 1–6 and Phase 5 units 7–1400.
...
`main` has Phase 5 local-software inspectability through unit 1400. It is not a trading-system authorization. The in-repo fixture pack is SYNTHETIC and is not market evidence. Units 101–1400 do not change the claim class.
