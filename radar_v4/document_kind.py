...
KNOWN_DOCUMENT_KINDS = frozenset(
    {
        ...
        "radar_v4.member_set_verify",
        "radar_v4.member_status_bind",
        "radar_v4.member_verify",
