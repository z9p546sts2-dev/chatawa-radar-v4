...
| `phase5/RADAR_V4_TWELVE_DATA_TEMPORARY_SOURCE_FIT_TC.md` | Temporary Twelve Data source-fit review for a proposed 30-session SPY cycle. Not a source, license, or extract. |
| `phase5/RADAR_V4_TWELVE_DATA_LICENSE_REVIEW_TC.md` | Authorized Twelve Data public-terms license review only. PASS WITH CONDITIONS for one private 30-session SPY cycle. Not a source or extract. |
