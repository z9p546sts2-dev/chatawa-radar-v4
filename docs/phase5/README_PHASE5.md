...
Proposed SYNTHETIC dress-rehearsal test plan: `docs/phase5/RADAR_V4_PRE_HISTORICAL_DRESS_REHEARSAL_PLAN_TC.md`. Not implemented. Not HISTORICAL. No vendor dependency.
