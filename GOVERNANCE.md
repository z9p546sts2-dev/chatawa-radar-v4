...
Radar V4 has Phase 5 dataset admission through a local FIXTURE/SYNTHETIC pack session, ruler identity, quarantine journal, and checksum sidecar. Vendor download and method research are not authorized. The in-repo fixture pack is not market evidence.
...
5. Phase 5 units 7–37 dataset admission through local pack session, ruler identity, quarantine journal, checksum sidecar, and CLI journal/registry/ruler-lock commands.
...
A later class of work (vendor API, Phase 6, paper trading) may begin only after Todd provides a new explicit authorization. Completion of Units 7–37 does not authorize that class.
...
PHASE 5 — AUTHORIZED-TC / UNITS 7–37 COMPLETE
