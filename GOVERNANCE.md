...
**PHASE 5 AUTHORIZED — UNITS 7–22 COMPLETE WITHIN SCOPE**

Radar V4 has Phase 5 dataset admission through a local FIXTURE/SYNTHETIC pack session, snapshot compare, and CLI. Vendor download and method research are not authorized. The in-repo fixture pack is not market evidence.
...
5. Phase 5 units 7–22 dataset admission through local pack session, snapshot compare, CLI, and a labeled SYNTHETIC fixture pack.
...
A later class of work (vendor API, Phase 6, paper trading) may begin only after Todd provides a new explicit authorization. Completion of Units 7–22 does not authorize that class.
...
PHASE 5 — AUTHORIZED-TC / UNITS 7–22 COMPLETE
