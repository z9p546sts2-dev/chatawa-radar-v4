...
**Status:** AUTHORIZED-TC / UNITS 7–18 COMPLETE WITHIN SCOPE
...
- Phase 5 units 7–18 dataset declaration through local pack session and session report.
...
Vendor download, paper trading, and Phase 6 still require a separate named authorization. Do not buy an API or open a paper account because Units 7–18 exist.
...
PHASE 5 — DATA / RESEARCH FOUNDATION                 AUTHORIZED-TC / UNITS 7–18 COMPLETE
