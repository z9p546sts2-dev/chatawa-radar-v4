...
**Status:** AUTHORIZED-TC / UNITS 7–250 COMPLETE WITHIN SCOPE FOR LOCAL SOFTWARE ONLY

Vendor download, paper trading, and method research remain unauthorized. Completing units 7–250 does not authorize a data purchase.
...
- Phase 5 units 7–250 dataset declaration through local pack session, integrity, inspect/compare/bind, claim/arithmetic/scope checks, pack safety, local audit copy, record/round-trip/catalog checks, hygiene/lineage/decimal/certify compose, and a workshop stop record.
...
Vendor download, paper trading, and Phase 6 still require a separate named authorization. Do not buy an API or open a paper account because Units 7–250 exist. The in-repo fixture pack is SYNTHETIC and is not market evidence.
...
PHASE 5 — DATA / RESEARCH FOUNDATION                 AUTHORIZED-TC / UNITS 7–250 COMPLETE
