...
Radar V4 has a bounded evidence foundation plus Phase 5 dataset session software on `main` through unit 1400. Vendor download and method research remain unauthorized.
...
**Status:** AUTHORIZED-TC / UNITS 7–1400 COMPLETE WITHIN SCOPE FOR LOCAL SOFTWARE ONLY

Vendor download, paper trading, and method research remain unauthorized. Completing units 7–1400 does not authorize a data purchase.
...
Vendor download, paper trading, and Phase 6 still require a separate named authorization. Do not buy an API or open a paper account because Units 7–1400 exist. The in-repo fixture pack is SYNTHETIC and is not market evidence.
...
PHASE 5 — DATA / RESEARCH FOUNDATION                 AUTHORIZED-TC / UNITS 7–1400 COMPLETE ON MAIN; LOCAL SOFTWARE ONLY
